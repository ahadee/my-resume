      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a href="mailto:bagushmahardhika@gmail.com" target="_blank" rel="noopener noreferrer">
            ...
            <div className="m-2">
              <a href="https://api.whatsapp.com/send?phone=+628113640817" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-success" title="You'll be directed to web whatsapp">
